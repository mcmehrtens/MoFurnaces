...
public class BrickFurnace extends BlockContainer {
    ...
    // Basic constructor
    protected BrickFurnace(boolean isActive) {
        super(Material.rock);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(FurnaceRegistry.BrickFurnaceIdle);
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isActive) {
            ...
            switch (BrickFurnace.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()]) {
                case 1:
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if (active) {
            worldIn.setBlockState(pos, FurnaceRegistry.BrickFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, FurnaceRegistry.BrickFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        } else {
            worldIn.setBlockState(pos, FurnaceRegistry.BrickFurnaceIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, FurnaceRegistry.BrickFurnaceIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
